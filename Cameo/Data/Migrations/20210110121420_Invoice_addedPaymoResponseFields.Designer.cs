...
namespace Cameo.Data.Migrations
{
    ...
    [Migration("20210110121420_Invoice_addedPaymoResponseFields")]
    partial class Invoice_addedPaymoResponseFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cameo.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("TalentConfirmationCode")
                        .HasMaxLength(8);
            ...
            modelBuilder.Entity("Cameo.Models.ClickTransaction", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Cameo.Models.Invoice", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Cameo.Models.SocialArea", b =>
                {
                    ...
                    b.Property<string>("CompanySocialAreaHandle");
            ...
            modelBuilder.Entity("Cameo.Models.Talent", b =>
                {
                    ...
                    b.Property<string>("FullNameTransliterated")
                        .HasMaxLength(256);
            ...
            modelBuilder.Entity("Cameo.Models.WithdrawRequest", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Cameo.Models.WithdrawRequestStatus", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Cameo.Models.WithdrawRequest", b =>
                {
                    ...
                    b.HasOne("Cameo.Models.WithdrawRequestStatus", "Status")
                        .WithMany()
